...
const AddBikePage = () => {
    ...
    const [bikePhoto, setBikePhoto] = useState(null); // For storing image file
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('bikeDescription', bike.bikeDescription);
        formData.append('perDayRental', bike.perDayRental);
        formData.append('isAvailable', bike.isAvailable);
        formData.append('bikePhoto', bikePhoto); // append image blob
    ...
    return (
        <div style={{
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <label htmlFor="bikePhoto" style={{ marginBottom: '5px', color: '#555' }}>Bike Photo (Upload):</label>
                    <input
                        type="file"
                        id="bikePhoto"
                        name="bikePhoto"
